...
def creer_bouton_info(plugins, id, filtre="nom"):
    ...
    button_list = [
        InlineKeyboardButton(
            "Modifier", callback_data="{}_modifier_{}".format(plugins, id)
        ),
        InlineKeyboardButton(
            "Supprimer", callback_data="{}_suppr_{}_{}".format(plugins, id, filtre)
        ),
        InlineKeyboardButton(
            "Retour liste", callback_data="{}_lister_{}".format(plugins, filtre)
        ),
    ]
    if plugins in ["sncf"]:
        button_list.append(
...
def button_supprimer(update: Update, context: CallbackContext):
    ...
    button_list = [
        InlineKeyboardButton(
            "Retour", callback_data="{}_lister_{}".format(plugins, filtre)
        ),
    ]
