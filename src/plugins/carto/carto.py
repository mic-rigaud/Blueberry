...
def button_graph(update: Update, context: CallbackContext):
    ...
    remplir_ip_voisin()
    creer_carto()
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open('Network.gv.png', 'rb'))
...
def carto(update: Update, context: CallbackContext):
    ...
    context.bot.send_message(chat_id=update.message.chat_id,
                             text=reponse, parse_mode=telegram.ParseMode.HTML,
                             reply_markup=reply_markup)
...
def add(dispatcher):
    ...
    dispatcher.add_handler(CallbackQueryHandler(button_pingall, pattern="carto_pingall"))
